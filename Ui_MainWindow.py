...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_4.addWidget(self.chkDirectionSizeToAll, 4, 2, 1, 1)
        self.btnStart = QtWidgets.QPushButton(parent=self.frame_2)
        self.btnStart.setObjectName("btnStart")
        self.gridLayout_4.addWidget(self.btnStart, 8, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chkDirectionSizeToAll.setText(_translate("MainWindow", "Задать единный размер"))
